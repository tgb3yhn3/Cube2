...
class RubiksOpenCV(object):
    ...
    def analyze(self, webcam: bool, cube_size: None = None) -> bool:
        ...
        self.display_candidates(self.image, "150 Final", missing,True)
        ...
        for index in range(squares_per_side):
            square_index = self.nowFace+square_indexes[index]
...
class RubiksImage(RubiksOpenCV):
    def display_candidates(self, image: ndarray, desc: str, missing: List = None,final:bool=False) -> None:
        """
